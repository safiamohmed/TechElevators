...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#f9fafb] dark:bg-slate-800 text-center p-6 transition-all duration-500">
      ...
      <h1 className="text-6xl font-bold text-blue-400 mb-4">Oops! 😅</h1>

      <p className="text-xl text-gray-700 dark:text-gray-300 mb-6 max-w-xl">
        It seems like something went wrong... but don’t worry, we’re working on it! 🔧💙
      </p>

      <Image
        src={theme === "dark" ? "/oops4.jpg" : "/oopslight.png"}
